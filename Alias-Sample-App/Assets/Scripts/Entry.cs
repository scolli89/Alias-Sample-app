...
public class Entry
{
    ...
    // 1. It is used by the SceneSpawner as the holder of list of prefabs to spawn. Here the script field goes un-used as non of the prefabs 
    ...
    ///<notes>
    /*
    The class was reused for both above purposes as it was deemed simpler than creating another class that split the functionalities. 
    */
    ///</notes>
    public Entry(){}
